...
function insertPagination(totalPage, pageNo) {
    ...
    let firstAnchor = $(document.createElement("a")).addClass("page-link").attr("href", "/board/printList.jsp?pageNo=1");    //attr은 setAttribute
    ...
    let lastAnchor = $(document.createElement("a")).addClass("page-link").attr("href", "/board/printList.jsp?pageNo=" + totalPage);    //attr은 setAttribute
